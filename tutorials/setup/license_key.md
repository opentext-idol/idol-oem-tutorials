...
1. On the "License Activation" screen, at the bottom, select the check box, choose your preferred version (the latest is 24.1), then fill in the quantity to activate:
