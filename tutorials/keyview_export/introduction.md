...
1. From the list of available files, select and download the following (depending on your platform):
   - `KeyviewExportSDK_25.1.0_{PLATFORM}`, *e.g.* `KeyviewExportSDK_25.1.0_WINDOWS_X86_64.zip` or `KeyviewExportSDK_25.1.0_LINUX_X86_64.exe` or similar for other supported platforms
   - `KeyviewExportSDK_25.1.0_Documentation.zip`
...
1. From the list of available files, select and download any available patches for, *e.g.* `KeyviewExportSDK 25.1 Patch 25.1.x`.
...
1. Extract `KeyviewExportSDK_<VERSION>_<PLATFORM>.zip` file to:
   - `C:\OpenText\KeyviewExportSDK_25.1.0_WINDOWS_X86_64`
...
1. This lesson will refer to `C:\OpenText\KeyviewExportSDK_25.1.0_WINDOWS_X86_64` as `%KEYVIEW_HOME%`.
1. If a patch is available for version being used, then extract *e.g.* `KeyviewExportSDK_25.1.x.yyyy.zip` to:
   - `C:\OpenText\KeyviewExportSDK_25.1.x.yyyy`
1. Backup existing files and copy new ones from appropriate `KeyviewFilterSDK_<VERSION>\<PLATFORM>` folder. It is most likely that patch files will be updates to those in `%KEYVIEW_HOME%\<PLATFORM>\bin` folder and sub-folders:
   - `C:\OpenText\KeyviewExportSDK_25.1.0_WINDOWS_X86_64\WINDOWS_X86_64\bin`
...
https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/html-export-c/Content/export/Introduction/Introduction.htm) for more details on installation.

## Introduction to Export SDK

To get oriented with key concepts please read the [Introducing Export SDK - Features](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/html-export-c/Content/export/Introduction/Features.htm) of the HTML/XML/PDF Export SDK * Programming Guides before continuing.
...
```sh
> cd C:\OpenText\KeyviewExportSDK_25.1.0_WINDOWS_X86_64\WINDOWS_X86_64\bin
> kvhtmlexport
...
See the [HTML Export SDK Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/html-export-c/Content/C/samples_export/kvhtmlexport.htm) for more details about `kvhtmlexport`.
...
See the [XML Export SDK Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/xml-export-c/Content/C/samples_export/cnv2xml.htm) for more details about `cnv2xml`.
...
See the [PDF Export SDK Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/pdf-export-c/Content/C/samples_export/cnv2pdf.htm) for more details about `cnv2pdf`.
...
- [HTML SDK Java Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/html-export-java/index.html)
- [XML Export C Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/xml-export-c/index.html)
- [XML Export Java Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/xml-export-java/)
- [PDF Export C Programming Guide](https://www.microfocus.com/documentation/idol/knowledge-discovery-25.1/KeyviewExportSDK_25.1_Documentation/Guides/html/pdf-export-c/index.html)
