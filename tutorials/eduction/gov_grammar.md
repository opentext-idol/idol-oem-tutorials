...
- [Government edk_samples](../../resources/eduction/gov/edk_samples) and install to `C:\OpenText\EductionGrammars_24.3.0_COMMON\gov\edk_samples\resources`
...
For full details of the entities included in the Government Grammar Package, please reference the [Government Package Technical Note](https://www.microfocus.com/documentation/idol/IDOL_24_3/EductionGrammars_24.3_Documentation/GOV/Content/PackGov/PackGov_GrammarReference.htm)
...
```sh
> cd C:\OpenText\EductionGrammars_24.3.0_COMMON\gov\edk_samples\resources
> edktool extract -l ..\..\..\..\EductionSDK_24.3.0_WINDOWS_X86_64\licensekey.dat -c gov_all\config\gov_all.cfg -i gov_all\input\input.txt -o out.xml
```
...
- [IDOL Government Package Technical Note](https://www.microfocus.com/documentation/idol/IDOL_24_3/EductionGrammars_24.3_Documentation/GOV/)
