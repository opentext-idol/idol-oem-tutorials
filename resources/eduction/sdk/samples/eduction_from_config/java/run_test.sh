...
java -Djava.library.path=${EDK_HOME}/bin -cp ${EDK_HOME}/bin/edk.jar:./target/classes com.autonomy.eduction.samples.FromConfig ${configPath} ${inputFilePath} ${outputFilePath} ${sessionConfigPath} ${EntityMatchLimit}
