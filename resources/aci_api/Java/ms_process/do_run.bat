...
rem java -jar target/%PROGRAM%-1.0-SNAPSHOT-jar-with-dependencies.jar %ACI_HOST% %ACI_PORT% %CONFIG_NAME% "%SOURCE_FILE_PATH%"

rem mvn exec:java -Dexec.args="%ACI_HOST% %ACI_PORT% %CONFIG_NAME% '%SOURCE_FILE_PATH%'"