...
public class FetchDelete {
    ...
    private static final Logger LOG = Logger.getLogger(FetchDelete.class.getName());
	...
	static class Args {
		...
		{
			System.console().printf("Usage: FetchDelete <HOSTNAME/IP> <ACI_PORT_#> <IDENTIFIERS_CSV>\n");
    ...
    private void fetch_delete(String[] args) throws Exception
	{
		Args parsedArgs;
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        FetchDelete obj = new FetchDelete();

        try {
            obj.fetch_delete(args);
        } catch(Exception e) {
