...
{
	printf("Usage: fetch_identifiers <HOSTNAME/IP> <ACI_PORT_#> <IDENTIFIERS_CSV>\n");
	printf("Parameters:\n");
...
int main(int argc, char** argv)
{
	...
	{
		printf("Error: Program requires three arguments.\n");
		displayusageinfo();
		exit(1);
	}
	...
	aciObjectParamSetString(pCommand, "fetchAction", "delete");
