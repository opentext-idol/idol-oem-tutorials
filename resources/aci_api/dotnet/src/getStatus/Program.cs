...
namespace getStatus
{
    class Program
    {
		...
		private const Int16 EXPECTED_NUM_ARGS = 2;
		
        static void DisplayUsageInfo()
        {
            Console.WriteLine("Usage: getStatus <HOSTNAME/IP> <ACI_PORT_#>\n");
        ...
        static void GetStatus(String[] args)
        {
            ...
            Command getStatus = new Command("GETSTATUS");
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Error: Wrong number of arguments (two required).\n");
                DisplayUsageInfo();
                Environment.Exit(1);
            }
