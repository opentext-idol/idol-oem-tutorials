...
namespace fetchUpdate
{
    class Program
    {
        ...
        {
            Console.WriteLine("Usage: fetchUpdate <HOSTNAME/IP> <ACI_PORT_#> <IDENTIFIERS_XML_FILE>\n");
            ...
            Console.WriteLine("    <IDENTIFIERS_XML_FILE>      Update identifiers XML file.\n");
        }
        ...
        static void FetchUpdate(String[] args)
        {
			...
			String identifiersXML = System.IO.File.ReadAllText(args[3]);

            Command fetch = new Command("FETCH");
            fetch.Set("fetchAction", "update");
            fetch.Set("identifiersXML", identifiersXML);
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("IdentifiersXML file: {0}", args[2]);
