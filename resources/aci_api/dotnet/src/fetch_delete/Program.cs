...
namespace fetchDelete
{
    class Program
    {
        ...
        {
            Console.WriteLine("Usage: fetchDelete <HOSTNAME/IP> <ACI_PORT_#> <IDENTIFIERS_CSV>\n");
        ...
        static void fetchDelete(String[] args)
        {
